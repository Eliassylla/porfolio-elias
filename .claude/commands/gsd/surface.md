...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/elias/Claude Code/Portfolio/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/Users/elias/Claude Code/Portfolio/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/Users/elias/Claude Code/Portfolio/.claude/commands/gsd
AGENTS_DIR=/Users/elias/Claude Code/Portfolio/.claude/agents
```
...
<execution_context>
Surface state file: `/Users/elias/Claude Code/Portfolio/.claude/skills/.gsd-surface.json`
Install profile marker: `/Users/elias/Claude Code/Portfolio/.claude/skills/.gsd-profile`
Engine module: `/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
