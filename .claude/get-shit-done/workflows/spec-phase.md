...
```bash
INIT=$(node "/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/templates/spec.md.
