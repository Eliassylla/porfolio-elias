...
```
Agent(
  prompt="Read /Users/elias/Claude Code/Portfolio/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/templates/SECURITY.md`
