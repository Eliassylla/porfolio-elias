...
```
Agent(
  prompt="Read /Users/elias/Claude Code/Portfolio/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/templates/VALIDATION.md`
