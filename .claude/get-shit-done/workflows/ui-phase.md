...
```markdown
Read /Users/elias/Claude Code/Portfolio/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/elias/Claude Code/Portfolio/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/elias/Claude Code/Portfolio/.claude/agents/gsd-ui-checker.md for instructions.
