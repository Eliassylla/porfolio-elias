...
INSTALL_JS_GLOBAL="/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/elias/Claude Code/Portfolio/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
