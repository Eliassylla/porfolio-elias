...
```bash
INIT=$(node "/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
