...
<template>
@/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/workflows/diagnose-issues.md
