...
<required_reading>
@/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/references/ai-frameworks.md
@/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/elias/Claude Code/Portfolio/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/elias/Claude Code/Portfolio/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/elias/Claude Code/Portfolio/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/elias/Claude Code/Portfolio/.claude/agents/gsd-eval-planner.md for instructions.
