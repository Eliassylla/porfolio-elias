...
- Saves timestamped note to `.planning/notes/` (or `/Users/elias/Library/Mobile Documents/com~apple~CloudDocs/Business/Antigravity/Portfolio/.claude/notes/` globally)
