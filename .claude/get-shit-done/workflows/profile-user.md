...
Key references:
- @/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/elias/Claude Code/Portfolio/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/USER-PROFILE.md" "/Users/elias/Claude Code/Portfolio/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/elias/Claude Code/Portfolio/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/elias/Claude Code/Portfolio/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/elias/Claude Code/Portfolio/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/elias/Claude Code/Portfolio/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/elias/Claude Code/Portfolio/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/elias/Claude Code/Portfolio/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/elias/Claude Code/Portfolio/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/elias/Claude Code/Portfolio/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/elias/Claude Code/Portfolio/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/elias/Claude Code/Portfolio/.claude/CLAUDE.md
```
