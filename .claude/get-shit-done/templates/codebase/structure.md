...
- Usage: Reference from command with `@/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/elias/Claude Code/Portfolio/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/elias/Claude Code/Portfolio/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
