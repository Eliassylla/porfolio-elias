...
<reference>
@/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/references/user-profiling.md` to load:
