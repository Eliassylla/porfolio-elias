...
Reference full template: `/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/elias/Claude Code/Portfolio/.claude/get-shit-done/templates/state.md`.
