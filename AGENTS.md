# Portfolio Antigravity — Instructions Codex
...
```
.Codex/skills/     ← SOURCE DE VÉRITÉ (vrais fichiers, lus directement par Codex)
```

**Pour ajouter un nouveau skill :**
1. Créer le dossier `.Codex/skills/[nom-skill]/`
